...
export class ContactService {
  ...
  async createContact(createContactDto : ReqContactDto, userId : string): Promise<Contact> {
  ...
  async updateContact(id: string, userId: string, updateContactDto: ReqContactDto): Promise<Contact> {
    ...
    console.log(userId)
    const updateContact = await this.contactRepository.update(updateContactDto, id);
